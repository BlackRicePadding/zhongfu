...
module.exports = {
  ...
  output: {//输出文件
    ...
    // publicPath: '',//添加静态资源
    chunkFilename: 'static/js/[name].js',//CommonsChunkPlugin提取的公共文件
  ...
  module: {
    rules: [
      ...
      {
        test: /\.(png|jpe?g|gif|otf|svg|eot|ttf|woff|woff2)(\?.*)?$/,
        loader: 'url-loader',
        query: {
          // limit: 10000,
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([{ from: path.resolve(__dirname, 'static/js'), to: 'static/js' }]),//复制js库
